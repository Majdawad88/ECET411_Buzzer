...
GPIO.setup(BUZZER_PIN, GPIO.OUT, initial=GPIO.LOW) # Set pin 8 to be an output pin and set initial value to low (off)
...
try:
	...
	while True: # Run forever
		GPIO.output(BUZZER_PIN, GPIO.HIGH) # Turn on print(' BUZZER ON')
		sleep(1)	# Sleep for 1 second
		GPIO.output(BUZZER_PIN, GPIO.LOW) # Turn off print(' BUZZER OFF')
		sleep(1)	# Sleep for 1 second
